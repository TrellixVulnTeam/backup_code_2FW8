package laya.ui {
	...
	public class DialogManager extends Sprite {
		...
		public var popupEffect:Function = function(dialog:Sprite):void {
			dialog.scale(1, 1);
			dialog.alpha = 1;
			Tween.from(dialog, {x: Laya.stage.width / 2 - dialog.width*0.3, y: Laya.stage.height / 2-dialog.height*0.3, scaleX: 0.6, scaleY: 0.6}, 300, Ease.backOut, Handler.create(this, this.doOpen, [dialog]));
		}
		...
		public var closeEffect:Function = function(dialog:Sprite, type:String):void {
			Tween.to(dialog, {alpha:0}, 300, Ease.linearOut, Handler.create(this, this.doClose, [dialog, type]));
		}
