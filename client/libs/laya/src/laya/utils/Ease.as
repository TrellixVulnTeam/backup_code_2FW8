package laya.utils {
	...
	public class Ease {
		 ...
		 * @return 指定时间的插补属性的值。
		 */
		public static function elasticOut(t:Number, b:Number, c:Number, d:Number, a:Number = 0, p:Number = 750):Number {
			/*[DISABLE-ADD-VARIABLE-DEFAULT-VALUE]*/
			var s:Number;
			if (t == 0) return b;
			if ((t /= d) == 1) return b + c;
		...
		public static function elasticOut2(t:Number, b:Number, c:Number, d:Number, a:Number = 2.2, p:Number = 0):Number {
			/*[DISABLE-ADD-VARIABLE-DEFAULT-VALUE]*/
			var s:Number;
			if (t == 0) return b;
			if ((t /= d) == 1) return b + c;
