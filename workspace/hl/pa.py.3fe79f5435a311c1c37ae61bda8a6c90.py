...
def getDetailInfo(pid):
    infoDetail = json.loads(requests.post('https://m.ctrip.com/restapi/soa2/12455/json/BnbCommentList?_fxpcqlniredt=09031107110690501469', {
    "pid": pid,
    "searchType": 2,
    "tagId": 0,
    "pageindex": 0,
...
def getExtraInfo(pid):
 ...
 with open('lk.json', 'a', encoding='utf-8') as f:
