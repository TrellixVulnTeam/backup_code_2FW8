...
const Groups = (function () {
  ...
  return {
    ...
    getObj: function (sprite) {
      return groupObj.get(sprite);
    }
  }
})();
...
class CollisionCompnent extends Component {
  ...
  update() {
    ...
    collisionGroup.forEach(sprite => {
      sprite[this.collisionType](this.parent.sprite, () => this._handler(Groups.getObj(sprite)));
    });
